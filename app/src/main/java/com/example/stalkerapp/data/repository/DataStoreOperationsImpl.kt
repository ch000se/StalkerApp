...
import com.example.stalkerapp.util.Constants.PREFERENCES_KEY
import com.example.stalkerapp.util.Constants.PREFERENCES_NAME
...
class DataStoreOperationsImpl(context: Context): DataStoreOperations {
    ...
    override suspend fun saveOnBoardingState(state: Boolean) {
        dataStore.edit { preferences ->
            preferences[PreferenceKeys.onBoardingKey] = state
        }
    }
